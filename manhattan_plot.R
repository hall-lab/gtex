...
plot(logp~start, data=p, pch=21, col='black', bg=p$col, cex=1.5, main=TITLE, axes=F, xlim=xlimits, ylim=ylimits, ylab='-log(p)', xlab=paste0('Chromosome ', p$chrom[1], ' position (kb)'))
box()
axis(2)
